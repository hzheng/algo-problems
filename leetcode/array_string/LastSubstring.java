...
public class LastSubstring {
    ...
    // time complexity: O(?), space complexity: O(N)
    // 11 ms(66.94%), 40.7 MB(97.01%) for 24 tests
    // Time Limited Exceeded (24/30 tests)
    public String lastSubstring3_2(String s) {
        char[] cs = s.toCharArray();
        int n = cs.length;
        Comparator<Integer> cmp = (i, j) -> (cs[j] == cs[i] ? j - i : cs[j] - cs[i]);
        ...
        int len = 0;
        int index = 0;
        for (PriorityQueue<Integer> npq; pq.size() > 1; len++, pq = npq) {
            npq = new PriorityQueue<>(cmp);
            char max = cs[pq.peek()];
    ...
    // Time Limited Exceeded (27/30 tests)
    ...
    // Two Pointers
    // time complexity: O(N), space complexity: O(1)
    // 10 ms(86.12%), 42 MB(77.96%) for 30 tests
    public String lastSubstring5_2(String s) {
        int start1 = 0;
        for (int start2 = 1, len = 0, n = s.length(); start2 + len < n; ) {
            char cur1 = s.charAt(start1 + len);
            char cur2 = s.charAt(start2 + len);
            ...
            if (cur1 > cur2) {
                ...
                start1 = Math.max(start1 + len + 1, start2);
                start2 = start1 + 1;
            }
            if (start1 == start2) {
                start2++;
    ...
    private void test(String s, String expected) {
        ...
        assertEquals(expected, lastSubstring3_2(s));
        assertEquals(expected, lastSubstring4(s));
        assertEquals(expected, lastSubstring5(s));
        assertEquals(expected, lastSubstring5_2(s));
    }
    ...
    @Test public void test() {
        ...
        test("",
